...
class HGTConv(MessagePassing):
    ...
    def message(self, edge_index_i, node_inp_i, node_inp_j, node_type_i, node_type_j, edge_type, edge_time):
        ...
        print(f'edge_index_i: {edge_index_i} ,shape: {edge_index_i.shape}')
        print(f'node_inp_i: {node_inp_i} ,shape: {node_inp_i.shape}')
        print(f'node_type_i: {node_type_i} , shape: {node_type_i.shape}')
        print(f'edge_type: {edge_type} ,shape: {edge_type.shape}')
        print(f'edge_time: {edge_time} ,shape: {edge_time.shape}')
        '''
