...
class MAG240M(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        # path = '/data/shangyihao/mag240m/new_feat0.1_0.7/train_index.pt'
        # self.train_idx = torch.load(path)
        ...
        x = np.memmap(f'/data/shangyihao/mag240m/new_structure1_feat0.1/feat_ratio.npy', dtype=np.float16,
                      mode='c', shape=(N, self.num_features+1))
...
if __name__ == '__main__':
    ...
    if not args.evaluate:
        model = RGNN(args.model, (datamodule.num_features+1),
