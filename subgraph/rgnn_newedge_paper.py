...
class MAG240M(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        path = '/data/shangyihao/mag240m/newedges0.1/full_adj.pt'
...
class RGNN(LightningModule):
    ...
    def validation_step(self, batch, batch_idx: int):
        ...
        valid_loss = F.cross_entropy(y_hat, batch.y)
    ...
    #     valid_loss_batch = []
    #     for _, out in outputs:  # out is train_losses of all batches
    #         valid_loss_batch.append(out.to(device='cpu'))
    #     loss = np.mean(valid_loss_batch)
    #     return loss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--hidden_channels', type=int, default=940)
    ...
    if not args.evaluate:
        ...
        trainer = Trainer(gpus=args.device, max_epochs=args.epochs,
                          ...
                          default_root_dir=f'logs/{args.model}_newedge')
        trainer.fit(model, datamodule=datamodule)
        # v_loss = model.validation_epoch_end()
