...
if __name__ == '__main__':
    ...
    parser.add_argument('--devices', type=str, default='4,5,6')
    ...
    seed_everything(42)
    # size = [i * n_gpus for i in args.sizes]
    ...
    if not args.evaluate:
        ...
        trainer = Trainer(gpus=args.devices, max_epochs=args.epochs,
                          # auto_scale_batch_size='binsearch',
                          # replace_sampler_ddp=False,
                          callbacks=[checkpoint_callback], accelerator='ddp',
                          default_root_dir=f'logs/{args.model}_try')
