...
parser.add_argument('--author-output-path', type=str, default='/data/shangyihao/mag240m/RGAT/author0.01_0.npy',
                    help='Path to store the author features.')
parser.add_argument('--inst-output-path', type=str, default='/data/shangyihao/mag240m/RGAT/inst0.01_0.npy',
                    help='Path to store the institution features.')
parser.add_argument('--graph-output-path', type=str, default='/data/shangyihao/mag240m/RGAT/graph0.01_0.dgl',
...
parser.add_argument('--full-output-path', type=str, default='/data/shangyihao/mag240m/RGAT/full0.01_0.npy',
                    help='Path to store features of all nodes.  Effective only when graph is homogeneous.')
args = parser.parse_args()

print('Building graph')
dataset = MAG240MDataset(2, 0.01, 0)
...
# g.nodes['paper'].data['year'] = torch.unsqueeze(years, dim=0).T
