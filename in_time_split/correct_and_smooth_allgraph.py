...
if __name__ == '__main__':
    ...
    path = f'{dataset.dir}/process_shang/all_graph_split/paper_to_paper_symmetric_gcn.pt'
    if osp.exists(path):
        adj_t = torch.load(path)
    else:
        path_sym = f'{dataset.dir}/process_shang/all_graph_split/paper_to_paper_symmetric.pt'
